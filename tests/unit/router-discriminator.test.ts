...
const config = {
  ...
  openapi: {
    filePath: path.resolve(__dirname, 'generated-openapi-router-discriminator.json'),
    service: {
      name: 'my-service',
      version: '1.0.0'
    }
...
test('Should successfully generate with valid discriminator function', async () => {
  await assert.doesNotReject(() => generate(Object.assign({}, config, {
    controllers: [path.resolve(__dirname, '../fixtures/controllers/controller-middleware.ts')]
  })));
...
test('Should fail generate with not found discriminator function', async () => {
  await assert.rejects(() => generate(Object.assign({}, config, {
    controllers: [path.resolve(__dirname, '../fixtures/routing/router-controller-discriminator-not-found.ts')]
...
test('Should fail generate with discriminator function declared twice', async () => {
  await assert.rejects(() => generate(Object.assign({}, config, {
    controllers: [path.resolve(__dirname, '../fixtures/routing/router-controller-discriminator-twice.ts')]
...
test('Should fail generate with discriminator function not exported', async () => {
  await assert.rejects(() => generate(Object.assign({}, config, {
    controllers: [path.resolve(__dirname, '../fixtures/routing/router-controller-discriminator-not-exported.ts')]
...
test('Should fail generate with discriminator function invalid', async () => {
  await assert.rejects(() => generate(Object.assign({}, config, {
    controllers: [path.resolve(__dirname, '../fixtures/routing/router-controller-discriminator-arrow-fn.ts')]
